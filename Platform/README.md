The Night.Platform library is a small C99 utility library that implements native methods required to run an application, as well as compiling and dynamically linking SDL3.
