...
namespace Night
{
  ...
  public interface IGame
  {
    ...
    void KeyReleased(KeySymbol key, KeyCode scancode) { /* Optional: Default empty implementation */ }
    ...
    void MousePressed(int x, int y, MouseButton button, bool istouch, int presses) { /* Optional: Default empty implementation */ }
    ...
    void MouseReleased(int x, int y, MouseButton button, bool istouch, int presses) { /* Optional: Default empty implementation */ }
  }
